...
const THEMES = {
  default: {
    ...
    styles: {
      // 全局容器
      wrapper: 'color: #333333; font-size: 18px; line-height: 1.8; word-break: break-word; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif;',
      // 标题
      h1: 'font-size: 30px; font-weight: bold; color: #1a73e8; border-bottom: 2px solid #1a73e8; padding-bottom: 8px; margin: 30px 0 15px 0; line-height: 1.4;',
      h2: 'font-size: 24px; font-weight: bold; color: #1a73e8; border-left: 4px solid #1a73e8; padding-left: 12px; margin: 28px 0 14px 0; line-height: 1.4;',
      ...
      // 段落
      p: 'margin: 12px 0; color: #333333; font-size: 18px; line-height: 1.8;',
      // 强调
      ...
      // 列表
      ul: 'margin: 12px 0; padding-left: 28px; color: #333333; font-size: 18px; line-height: 1.8;',
      ol: 'margin: 12px 0; padding-left: 28px; color: #333333; font-size: 18px; line-height: 1.8;',
      li: 'margin: 4px 0; color: #333333; font-size: 18px; line-height: 1.8;',
      // 行内代码
  ...
  green: {
    ...
    emoji: '🌿',
    styles: {
      wrapper: 'color: #2d3436; font-size: 18px; line-height: 1.8; word-break: break-word; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif;',
      h1: 'font-size: 30px; font-weight: bold; color: #059669; border-bottom: 2px solid #059669; padding-bottom: 8px; margin: 30px 0 15px 0; line-height: 1.4;',
      h2: 'font-size: 24px; font-weight: bold; color: #059669; border-left: 4px solid #059669; padding-left: 12px; margin: 28px 0 14px 0; line-height: 1.4;',
      ...
      h4: 'font-size: 18px; font-weight: bold; color: #555555; margin: 20px 0 10px 0; line-height: 1.4;',
      p: 'margin: 12px 0; color: #2d3436; font-size: 18px; line-height: 1.8;',
      ...
      ul: 'margin: 12px 0; padding-left: 28px; color: #2d3436; font-size: 18px; line-height: 1.8;',
      ol: 'margin: 12px 0; padding-left: 28px; color: #2d3436; font-size: 18px; line-height: 1.8;',
      li: 'margin: 4px 0; color: #2d3436; font-size: 18px; line-height: 1.8;',
  ...
  pink: {
    ...
    styles: {
      wrapper: 'color: #333333; font-size: 18px; line-height: 1.8; word-break: break-word; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif;',
      h1: 'font-size: 30px; font-weight: bold; color: #db2777; border-bottom: 2px solid #f472b6; padding-bottom: 8px; margin: 30px 0 15px 0; line-height: 1.4;',
      h2: 'font-size: 24px; font-weight: bold; color: #db2777; border-left: 4px solid #f472b6; padding-left: 12px; margin: 28px 0 14px 0; line-height: 1.4;',
  ...
  purple: {
    ...
    styles: {
      wrapper: 'color: #333333; font-size: 18px; line-height: 1.8; word-break: break-word; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif;',
      h1: 'font-size: 30px; font-weight: bold; color: #7c3aed; border-bottom: 2px solid #a78bfa; padding-bottom: 8px; margin: 30px 0 15px 0; line-height: 1.4;',
      h2: 'font-size: 24px; font-weight: bold; color: #7c3aed; border-left: 4px solid #a78bfa; padding-left: 12px; margin: 28px 0 14px 0; line-height: 1.4;',
  ...
  orange: {
    ...
    styles: {
      wrapper: 'color: #333333; font-size: 18px; line-height: 1.8; word-break: break-word; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif;',
      h1: 'font-size: 30px; font-weight: bold; color: #ea580c; border-bottom: 2px solid #fb923c; padding-bottom: 8px; margin: 30px 0 15px 0; line-height: 1.4;',
      h2: 'font-size: 24px; font-weight: bold; color: #ea580c; border-left: 4px solid #fb923c; padding-left: 12px; margin: 28px 0 14px 0; line-height: 1.4;',
  ...
  brown: {
    ...
    emoji: '☕',
    styles: {
      wrapper: 'color: #3c3028; font-size: 18px; line-height: 1.8; word-break: break-word; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif;',
      h1: 'font-size: 30px; font-weight: bold; color: #78604c; border-bottom: 2px solid #a8896c; padding-bottom: 8px; margin: 30px 0 15px 0; line-height: 1.4;',
      h2: 'font-size: 24px; font-weight: bold; color: #78604c; border-left: 4px solid #a8896c; padding-left: 12px; margin: 28px 0 14px 0; line-height: 1.4;',
      ...
      p: 'margin: 12px 0; color: #3c3028; font-size: 18px; line-height: 1.8;',
      ...
      ul: 'margin: 12px 0; padding-left: 28px; color: #3c3028; font-size: 18px; line-height: 1.8;',
      ol: 'margin: 12px 0; padding-left: 28px; color: #3c3028; font-size: 18px; line-height: 1.8;',
      li: 'margin: 4px 0; color: #3c3028; font-size: 18px; line-height: 1.8;',
...
function generateStudioStyles(primary, accent) {
  ...
  return {
    // 全局容器
    wrapper: 'color: #2c3e50; font-size: 18px; line-height: 1.9; word-break: break-word; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif;',

    // ★ H1: 居中 + 渐变背景色块 + 大圆角
    h1: `font-size: 30px; font-weight: 800; color: #ffffff; text-align: center; background: linear-gradient(135deg, ${primary}, ${accent}); padding: 14px 24px; border-radius: 12px; margin: 32px 0 18px 0; line-height: 1.5; letter-spacing: 1px; box-shadow: 0 4px 15px rgba(${primaryRgb}, 0.3);`,

    // ★ H2: 居中 + 渐变底部装饰线
    h2: `font-size: 24px; font-weight: 700; color: ${primary}; text-align: center; margin: 28px 0 14px 0; line-height: 1.4; padding-bottom: 10px; border-bottom: 3px solid transparent; background-image: linear-gradient(#fff, #fff), linear-gradient(90deg, ${primary}, ${accent}); background-origin: padding-box, border-box; background-clip: padding-box, border-box; border-bottom: 3px solid ${primary}; background: none; border-bottom: 3px solid transparent; border-image: linear-gradient(90deg, ${primary}, ${accent}) 1;`,
    ...
    // 段落
    p: 'margin: 14px 0; color: #2c3e50; font-size: 18px; line-height: 1.9;',
    ...
    // 列表
    ul: 'margin: 14px 0; padding-left: 28px; color: #2c3e50; font-size: 18px; line-height: 1.9;',
    ol: 'margin: 14px 0; padding-left: 28px; color: #2c3e50; font-size: 18px; line-height: 1.9;',
    li: 'margin: 5px 0; color: #2c3e50; font-size: 18px; line-height: 1.9;',
