...
> **💡 小提示：** 点击上方最后一个 ✦ 按钮试试 Studio 主题，它有完全不同的视觉风格——居中标题、渐变色块、胶囊代码标签。点击工具栏的 ⚙️ 配色按钮还能自定义颜色哦！
`;
...
class App {
    ...
    init() {
        ...
        // 初始化 Studio 主题配置面板
        this.customizer = new ThemeCustomizer(this.themeManager);
